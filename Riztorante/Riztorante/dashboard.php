...
<html lang="en">
    ...
    <body>
        ...
        <header class="l-header" id="header">
            <nav class="nav bd-container">
                ...
                <div class="nav__menu" id="nav-menu">
                    ...
                    <ul class="nav__list">
                    <li class="nav__item"><a href="dashboard.php" class="nav__link active-link">Home</a></li>
                    <li class="nav__item"><a href="aboutusadmin.html" class="nav__link">About</a></li>
                    <li class="nav__item"><a href="serviceadmin.html" class="nav__link">Services</a></li>
                    <li class="nav__item"><a href="menuadmin.html" class="nav__link">Menu</a></li>
                    <li class="nav__item"><a href="#reservasi" class="nav__link">Reservasi</a></li>
                    <li class="nav__item"><a href="#contact" class="nav__link">Contact</a></li>
                    <li class="nav__item"><a href="newsadmin.html" class="nav__link">News&Events</a></li>
                    <li class="nav__item"><a href="partnershipadmin.html" class="nav__link">Partnership</a></li>
                    <li class="nav__item"><a href="cariradmin.html" class="nav__link">Career</a></li>
                    <li class="nav__item"><a href="#feedback" class="nav__link">Feedback</a></li>
                    <li class="nav__item"><a href="home.html" class="nav__link">Log Out</a></li>
        ...
        <main class="l-main">
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h1 class="home__title" style="font-style: italic;" >De Fleur</h1>
                        <h2 class="home__subtitle"> Italian cuisine for all your dining occasions since 2023
                            </h2>
            <!--========== HOME button to menu ==========-->
                            <a href="#" class="button" onclick="scrollToMenu()">View Menu</a>
            <!--========== JS in line button to menu ==========-->
                            <script>
                            function scrollToMenu() {
                                // Mengambil elemen menu dengan ID 'menu'
                                var menuSection = document.getElementById('menu');  
                                // Scroll ke bagian menu menggunakan metode scrollIntoView()
                                menuSection.scrollIntoView({ behavior: 'smooth' });
                            }
                            </script>
                       </div>
    
                       <img src="home (1).png" style="max-width: 100%; height: 500px; margin-top: 200px; width: 500px;">
                </div>
            </section>
            ...
            <section class="about section bd-container" id="about">
                <div class="about__container  bd-grid">
                    <div class="about__data">
                        ...
                        <h2 class="section-title about__initial" style="font-style: italic;">Italian restaurant in Lenmarc Mall, West Surabaya. </h2>
                        <p class="about__description">De Fleur Ristorante is an Italian restaurant in Lenmarc Mall, West Surabaya.
                            Established in December 2023, we have been serving authentic Italian menus; Pizza, Pasta, and the famous Bistecca.
                            With the strong figure of Chef  Nasywa Nataliza, an Italian-born Chef from Puglia region, Italy.
                            We have become a place for family, friends and companies to enjoy their meals ranging from casual eats to special events, such as birthday celebrations and company gatherings.</p>
                        <a href="about us.html" class="button">About us</a>
                    </div>

                    <img src="home (2).png"  style="max-width: 100%; height: auto;">
                </div>
            </section>
            ...
            <section class="services section bd-container" id="services">
                ...
                <h2 class="section-title" style="font-style: italic;">Our amazing services</h2>
            ...
            <section class="menu section bd-container" id="menu">
                ...
                <h2 class="section-title" style="font-style: italic;">Highlight of De Fleur Ristorante</h2>

                <div class="menu__container bd-grid">
                    <div class="menu__content">
                        <img src="Buttermilk-Vanilla_Panna_Cotta_with_Berries_and_Honey_2.jpeg-removebg-preview.png" alt="" class="menu__img">
                        <h3 class="menu__name">Buttermilk-Vanilla Panna Cotta with Berries and Honey</h3>
                        <span class="menu__detail">Of course dessert will always be available for you</span>                     
                    </div>

                    <div class="menu__content">
                        <img src="GAMBAR2/SANGRIA.png " alt="" class="menu__img">
                        <h3 class="menu__name">Red Sangria Recipe</h3>
                        <span class="menu__detail">We offer a tantalizing array of beverages to delight your senses.</span>
                    </div>
                    
                    <div class="menu__content">
                        <img src="GAMBAR2/PANNE.png" alt="" class="menu__img">
                        <h3 class="menu__name">Spicy Italian Pasta dish with mozarella and chorizo</h3>
                        <span class="menu__detail">Discover some authentic Italian menus at De Fleur</span>
                    </div>
                </div>
            </section>

 <!-- Gallery Section -->
    <span class="section-subtitle">Gallery Menu</span>
    <h2 class="section-title">Ristorante Menu Gallery</h2>

    <div class="menu__container bd-grid">
        <div class="menu__content">
            <img src="GAMBAR2/TIRAMISU.png" alt="" class="menu__img">
            <h3 class="menu__name">Dessert</h3>
            <span class="menu__detail">Of course dessert will always be available for you</span>
            <button class="cta">
        ...
        <div class="menu__content">
            <img src="GAMBAR2/BRODETTO DI PESCE 'TERRACOTA'.png" alt="" class="menu__img">
            <h3 class="menu__name">Main course</h3>
            <span class="menu__detail">Discover some authentic Italian menus at De Fleur</span>
            <button class="cta">
                <span class="hover-underline-animation"> Read more </span>
                <svg
        ...
        <div class="menu__content">
            <img src="GAMBAR2/RED HONEY LEMON.png" alt="" class="menu__img">
            <h3 class="menu__name">Beverage</h3>
            <span class="menu__detail">We offer a tantalizing array of beverages to delight your senses.</span>
            <button class="cta">
                <span class="hover-underline-animation"> Read more </span>
                <svg
 ...
 <!-- Gallery button-->
 <a href="menu.html" class="readmore-btn">
  ...
  <span class="text"> All Menu </span>
</a>

 

                               <!--========== RESERVASI ==========--> 
           <section class="about section bd-container" id="reservasi">
            <div class="about__container  bd-grid">
                <div class="about__data">
                    <span class="section-subtitle about__initial">Reservasi</span>
                    <h4 class="section-title about__initial" style="font-style: italic;" >Italian restaurant in Lenmarc Mall, West Surabaya. </h4>
                    <p class="about__description">De Fleur Ristorante is an Italian restaurant in Lenmarc Mall, West Surabaya.
                        Established in December 2023, we have been serving authentic Italian menus; Pizza, Pasta, and the famous Bistecca.
                        With the strong figure of Chef  Hazel Adeline, an Italian-born Chef from Puglia region, Italy.
                        We have become a place for family, friends and companies to enjoy their meals ranging from casual eats to special events, such as birthday celebrations and company gatherings.</p>
                    <a href="reservasi 2.php" class="button">Go Reservasi</a>
                </div>

                <img src="https://as1.ftcdn.net/v2/jpg/00/52/21/56/1000_F_52215685_5PLVDGIcKE1potPwMi1GU5VjXL0Fl75h.jpg" style="max-width: 100%; height: auto;">
            </div>
        </section>
            <!--========== CONTACT US ==========-->
            ...
            <section class="contact section bd-container" id="contact">
                <div class="contact__container bd-grid">
                    <div class="contact__data">
                        ...
                        <h2 class="section-title contact__initial" style="font-style: italic;" >Contact us</h2>
                        <p class="contact__description" style="text-align: center;" >If you want to reserve a table in our restaurant, contact us and we will attend you quickly, with our 24/7 chat service.</p>
                    </div>

                    <div class="contact__button" style="margin-top: 120px;">
                        <a href="contact.php" class="button" style="margin-left: -50px;">Contact us now</a>
                    </div>
                </div>
            </section>
        </main>
      ...
      <!--event-->
 <section class="Events section bd-container" id="event">
  <section class="event">
         <span class="section-subtitle">Events</span>
                        <h2 class="section-title" style="font-style: italic;" >Restaurant Up Coming Event</h2>
                        <div class="container" style="margin-left: 180px;">
                            <div class="event-info">
                                <div class="event-item">
                                    <img src="https://cellaraiders.com/cdn/shop/articles/wine-tasting-013120_2048x.jpg?v=1580495941" style="max-width: 250px;" alt="Event 1">
                                    <h2>Wine Tasting Night</h2>
                                    <p>Date: January 15, 2025</p>
                                    <p>Time: 7:00 PM - 9:00 PM</p>
                                    <p>Location: De Fleur Restaurant</p>
                                    <a href="#" class="btn">Learn More</a>
                                </div>
                                <div class="event-item">
                                    <img src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1a/72/6c/0b/caption.jpg?w=1200&h=-1&s=1" style="max-width: 250px;" alt="Event 2">
                                    <h2>Cooking Class</h2>
                                    <p>Date: February 20, 2025</p>
                                    <p>Time: 6:00 PM - 8:00 PM</p>
                                    <p>Location: De Fleur Kitchen</p>
                                    <a href="#" class="btn">Learn More</a>
                                </div>
                            </div>
                        </div>   
      ...
      <!--========== FOOTER ==========-->
      <footer class="footer section " style="background-color: rgb(119, 22, 22); margin-left: -245px; margin-right: -245px; margin-bottom: -50px;">
        <div class="footer__container bd-grid">
            <div class="footer__content" style="margin-left: 20px;">
                <a href="#" class="footer__logo" style="color: antiquewhite;">De Fleur</a>
                <span class="footer__description" style="color: #fde7cf;">Restaurant</span>
                <div class="share">
                    <button class="btn1">
                      ...
                      <span class="tooltiptext1">
                        ...
                        <div class="username">@DeFleur</div>
                      </span>
                    </button>
                    <button class="btn2">
                      ...
                      <span class="tooltiptext2">
                        ...
                        <div class="username">@DeFleurtwit</div>
                      </span>
                    </button>
                    <button class="btn3">
            ...
            <div class="footer__content">
                <h3 class="footer__title" style="color: #fde7cf;">Services</h3>
                <ul>
                    <li style="color: #fde7cf;">Delivery</li>
                    <li style="color: #fde7cf;">Pricing</li>
                    <li style="color: #fde7cf;">Fast Food</li>
                    <li style="color: #fde7cf;">Reserve your Spot</li>
                </ul>
            </div>

            <div class="footer__content">
                <h3 class="footer__title" style="color: #fde7cf;">Information</h3>
                <ul>
                    <li style="color: #fde7cf;">Event</li>
                    <li style="color: #fde7cf;">Contact Us</li>
                    <li style="color: #fde7cf;">Privacy Policy</li>
                    <li style="color: #fde7cf;">Terms of Services</li>
                </ul>
            </div>

            <div class="footer__content">
                <h3 class="footer__title" style="color: #fde7cf;">Address</h3>
                <ul>
                    <li style="color: #fde7cf;">Surabaya</li>
                    <li style="color: #fde7cf;">Lenmarc Mall GF No. 40 Jl. Bukit Darmo Golf Surabaya 60226</li>
                    <li style="color: #fde7cf;">031 – 5116 3366</li>
                    <li style="color: #fde7cf;">DeFleur@gmail.com</li>
                </ul>
            </div>
            
            
        </div class = "row" >
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d34705.761414316694!2d112.7176742153735!3d-7.293251845357845!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7fb962552a691%3A0xb5bb425c6cb8424e!2sKec.%20Wonokromo%2C%20Surabaya%2C%20Jawa%20Timur!5e0!3m2!1sid!2sid!4v1709872115682!5m2!1sid!2sid;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" style="margin-left: 20px;"></iframe>
        </div>
        </div>

        <p class="footer__copy">&#169; 2024 De Fleur Restaurant. All rights reserved</p>
    </footer>
